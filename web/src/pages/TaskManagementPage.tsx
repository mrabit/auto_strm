...
import { saveConfig, syncTask } from '../api';
...
export default function TaskManagementPage() {
  ...
  const handleSaveTask = useCallback(
    ...
    [config, creatingNew, editingIndex, persist],
  );
  ...
  return (
    <div>
      ...
      <TaskEditModal
        open={editingIndex !== null || creatingNew}
        task={creatingNew ? emptyTask() : editingIndex !== null ? config.tasks[editingIndex] : null}
        index={creatingNew ? null : editingIndex}
        defaults={{
        ...
        isNew={
          creatingNew || (editingIndex !== null ? isNewTask(config.tasks[editingIndex]) : false)
        }
